...
/**
  * 合并偏好
  */
object MixPrefJoinArtIdfWithMV {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val prefData = userPosVideosPrefData
      ...
      .map(row => {
        ...
        (uid, videoWtM, songWtM, artWtM, mvWtM, videoWtM.size + mvWtM.size)
      }).toDF("uid", "videoWtM", "songWtM", "artWtM", "mvWtM", "videoSize")
      .filter($"videoSize" >= 10)
      .repartition(1000)
